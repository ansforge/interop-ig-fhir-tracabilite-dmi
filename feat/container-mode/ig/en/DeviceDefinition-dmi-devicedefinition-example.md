# dmi-devicedefinition-example - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot

## Example DeviceDefinition: dmi-devicedefinition-example

Profile: [DMI DeviceDefinition](StructureDefinition-dmi-devicedefinition.md)
