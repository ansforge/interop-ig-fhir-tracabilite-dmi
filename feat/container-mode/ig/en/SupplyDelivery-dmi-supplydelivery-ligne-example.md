# dmi-supplydelivery-ligne-example - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot

## Example SupplyDelivery: dmi-supplydelivery-ligne-example

Profile: [DMI SupplyDelivery Ligne](StructureDefinition-dmi-supplydelivery-ligne.md)
