# DMI Organization EJ - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot
...
* Examples for this Profile: [DMI Organization EJ Example Name](Organization-dmi-organization-ej-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tdmi|current/StructureDefinition/StructureDefinition-dmi-organization-ej.json)
