# DMI SupplyRequest Entete Reponse - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot
...
* Examples for this Profile: [SupplyRequest/dmi-supplyrequest-entete-reponse-example](SupplyRequest-dmi-supplyrequest-entete-reponse-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tdmi|current/StructureDefinition/StructureDefinition-dmi-supplyrequest-entetereponse.json)
