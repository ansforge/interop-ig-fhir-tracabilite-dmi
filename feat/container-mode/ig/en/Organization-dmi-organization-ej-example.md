# dmi-organization-ej-example - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot

## Example Organization: dmi-organization-ej-example

Profile: [DMI Organization EJ](StructureDefinition-dmi-organization-ej.md)
