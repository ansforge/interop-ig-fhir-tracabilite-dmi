# dmi-devicerequest-example - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot

## Example DeviceRequest: dmi-devicerequest-example

Profile: [DMI DeviceRequest](StructureDefinition-dmi-devicerequest.md)
