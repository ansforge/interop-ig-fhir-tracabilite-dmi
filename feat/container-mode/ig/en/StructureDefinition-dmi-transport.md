# DMI Transport - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot
...
* Use this Extension: [DMI SupplyDelivery Transport](StructureDefinition-dmi-supplydelivery-transport.md)
* Examples for this Extension: [Bundle/dmi-bundle-delivery-example](Bundle-dmi-bundle-delivery-example.md) and [SupplyDelivery/dmi-supplydelivery-transport-example](SupplyDelivery-dmi-supplydelivery-transport-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tdmi|current/StructureDefinition/StructureDefinition-dmi-transport.json)
