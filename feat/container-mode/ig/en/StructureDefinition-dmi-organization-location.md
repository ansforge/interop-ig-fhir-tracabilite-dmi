...
* Use this Extension: [DMI Organization Interne](StructureDefinition-dmi-organization-interne.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tdmi|current/StructureDefinition/StructureDefinition-dmi-organization-location.json)
