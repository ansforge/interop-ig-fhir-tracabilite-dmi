...
Profile: [DMI Procedure](StructureDefinition-dmi-procedure.md)

**identifier**: id Intervention/identifier-idIntervention-example

**status**: Preparation

**subject**: [Anonymous Patient (no stated gender), DoB Unknown ( identifier-dmi-patient-example)](Patient-dmi-patient-example.md)
