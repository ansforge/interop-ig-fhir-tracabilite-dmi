# DMI SupplyDelivery Reception Unitaire - Traçabilité des Dispositifs Médicaux Implantables v3.0.0-ballot
...
* Examples for this Profile: [SupplyDelivery/dmi-supplydelivery-reception-unitaire-example](SupplyDelivery-dmi-supplydelivery-reception-unitaire-example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.tdmi|current/StructureDefinition/StructureDefinition-dmi-supplydelivery-reception-unitaire.json)
