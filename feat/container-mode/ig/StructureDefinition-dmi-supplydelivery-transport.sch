...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:SupplyDelivery">
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/tdmi/StructureDefinition/dmi-transport']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/tdmi/StructureDefinition/dmi-transport': maximum cardinality of 'extension' is 1</sch:assert>
