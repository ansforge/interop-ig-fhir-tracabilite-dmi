...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="count(f:focalDevice) &gt;= 1">focalDevice: minimum cardinality of 'focalDevice' is 1</sch:assert>
      <sch:assert test="count(f:focalDevice) &lt;= 1">focalDevice: maximum cardinality of 'focalDevice' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
