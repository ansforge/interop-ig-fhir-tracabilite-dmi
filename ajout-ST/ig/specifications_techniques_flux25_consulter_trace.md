# Flux 25 - ConsulterTrace - ANS IG Example v0.1.0
...
Ce flux utilise l’interaction « read »[^11] de l’API REST de HL7 FHIR. Il s’agit d’une requête HTTP GET adressant la ressource auditEvent.
